# pn-delayer-receiver-orders-senders-mock Lambda
...
and persists them into DynamoDB for mock sender orders.
...
| `LIMIT_TABLE`             | (Optional) Name of **pn-PaperDeliverySenderLimitMock** table        |
| `COUNTERS_TABLE`          | (Optional) Name of **pn-PaperDeliveryCountersMock** table           |
...
5. **Aggregate total estimates** per product+province in `pn-PaperDeliveryCountersMock`.
