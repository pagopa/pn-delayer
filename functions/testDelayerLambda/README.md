...
| **GET_DECLARED_CAPACITY**    | Legge la capacitù dichiarata di un driver per una specifica data ed area geografica.                                                                                | `["tenderId", "unifiedDeliveryDriver", "geoKey", "deliveryDate"]`                                                                                                                                                                     | 
...
```json
{
  ...
  "parameters": ["tenderId", "unifiedDeliveryDriver", "geoKey", "deliveryDate"]
}
```
